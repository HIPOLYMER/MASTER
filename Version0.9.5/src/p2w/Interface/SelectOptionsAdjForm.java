...
class SelectOptionsAdjForm extends JFrame  {
	...
	SelectOptionsAdjForm() {
		...
		pNum_L.setForeground(new Color(217, 0, 35));
...
//System.out.println("Subject : "+selectWhere);
	...
	private class AdjustProblemForm extends JFrame {
		...
		AdjustProblemForm() {
			...
			pNum_TB.setBorder(new TitledBorder(null, "번호", TitledBorder.LEADING, TitledBorder.ABOVE_TOP, null, new Color(217, 0, 35)));
